...
\author{\vspace{.5cm}}
\title{\vspace{.5cm}Calificación automática producto PYME Express\vspace{-10ex}}
\date{\vspace{.5cm}}
...
\fancypagestyle{plain}{%
  ...
  \fancyhf{}%
  \fancyhead[L]{\includegraphics[scale=0.25]{LOGO-COMPLETO-RGB.png}}
 % \fancyhead[R]{}
}
%\lhead{jecfgjefgc}
...
%      Entidad Federativa:       & AAA \\
  ...
  \hline
      ...
      Destino: & \Sexpr{terminos$destino_credito} & Nombre del Aval: & \Sexpr{terminos$nombre_aval}\\
      Ministración: & \Sexpr{terminos$tipo_ministracion}\\
      ...
      Tasa de intéres ordinaria: & \Sexpr{terminos$tasa_ordinaria*100}\%\\

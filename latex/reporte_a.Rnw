...
%      Entidad Federativa:       & AAA \\
  ...
  \hline
      ...
      Monto Autorizado: &  \$ \Sexpr{prettyNum(terminos$monto_autorizado, big.mark=",", scientific=FALSE, digits=2, nsmall=2)} & Costo de la garantía: & \Sexpr{terminos$costo_garantia}\%\\
       Tipo de crédito: & Crédito Simple & Nombre del Aval: & \Sexpr{terminos$nombre_aval}\\
       Destino: & \Sexpr{terminos$destino_credito} & Obligado Solidario: & \Sexpr{terminos$nombre_obligado_solidario}\\
